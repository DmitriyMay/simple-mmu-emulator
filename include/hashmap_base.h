...
_Bool hashmap_base_iter_valid(const struct hashmap_base *hb, const struct hashmap_entry *iter);
_Bool hashmap_base_iter_next(const struct hashmap_base *hb, struct hashmap_entry **iter);
_Bool hashmap_base_iter_remove(struct hashmap_base *hb, struct hashmap_entry **iter);
